...
const SearchCard = ({ id,snippet }) => {
    ...
    return (
      <Link to={"/watch?v=" + videoId+"&channelId="+channelId}>
        <div className="relative flex cursor-poiner px-10 w-full">
          <img
            alt="Video Thumbnail"
            className="bg-amber-600 my-2 w-[420px] h-72 mx-4 rounded-lg"
            src={url}
          />

          <span className="py-1 rounded-lg px-2 text-xs bg-[rgb(0,0,0)]/70 text-white top-64 left-[437px] absolute">
            1:22
          </span>
